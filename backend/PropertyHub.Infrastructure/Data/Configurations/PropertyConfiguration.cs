...
public sealed class PropertyConfiguration : IEntityTypeConfiguration<Property>
{
    public void Configure(EntityTypeBuilder<Property> builder)
    {
        ...
        builder.Property(property => property.NormalizedTitle).HasMaxLength(100).IsRequired();
        ...
        builder.Property(property => property.NormalizedAddress).HasMaxLength(250).IsRequired();
        builder.Property(property => property.Price).HasPrecision(18, 2);
        builder.Property(property => property.Area).HasPrecision(12, 2);
        builder.Property(property => property.AreaUnit).HasConversion<string>().HasMaxLength(20).IsRequired();
        builder.Property(property => property.AreaSquareFeet).HasPrecision(14, 2);
        ...
        builder.Property(property => property.RejectionReason).HasMaxLength(500);
        builder.Property(property => property.ModeratedAtUtc).HasPrecision(0);
